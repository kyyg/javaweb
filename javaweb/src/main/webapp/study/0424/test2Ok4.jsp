...
<!-- 서블릿에서는 getter와() setter()를 이용해서 값을 불러오거나 저장시켜준다. -->
...
<html>
<head>
<jsp:setProperty property="name" name="vo"/> <!-- 앞에서 넘어온 vo값을 name에 넣겠다 -->
<jsp:setProperty property="age" name="vo" value="25"/> <!-- 밸류는 생략된것. 넣으면 고정값 줄수있음. -->
