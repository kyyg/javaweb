...
<div class="container">
	<h2>Foramt 라이브러리</h2>
	<pre>
		사용용도 : 형식문자열을 지정할 때 사용한다. (쉼표, 화폐단위, 백분율...)
...
%>
	<div>
		...
		1-2. 화폐단위<br/>	
			...
			7654321 (USD) => <fmt:formatNumber value="${won}" type="currency" currencyCode="USD" /> <br/>
		...
		<hr/> 기타 <hr/>
		4.URL이동 : location.href=''; => redirect<br/>
		...
		6. import : <br/>
			...
			<%-- <%@page import="java.util.Date"%> 이렇게 써도 상관없음. 스크립틀릿 시르면 위에 --%>
	</div>
</div>
<p><br/></p>
</body>
