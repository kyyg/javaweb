...
<div class="container">
	...
	<form name="myform" method="post" action="${ctp}/BoardInputOk.bo">
		<table class="table table-bordered">
			...
			<tr>
				<th>글제목</th>
				<td><input type="text" name="title" placeholder="글제목을 입력하세요" id="title" autofocus required class="form-control" /> </td>
			</tr>
			<tr>
				<th>이메일</th>
			...
			<tr>
				<th>홈페이지</th>
				<td><input type="text" name="homePage" id="homePage" placeholder="홈페이지을 입력하세요" value="https://" class="form-control" /></td>
			</tr>
			<tr>
				<th>글내용</th>
			...
			<tr>
				<td colspan="2" class="text-center">
					...
					<input type="button" value="돌아가기" onclick="location.href='${ctp}/BoardList.bo'" class="btn btn-info" />
				</td>
			</tr>
		</table>
