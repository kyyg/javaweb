...
create table member(
	...
	address varchar(100),                /* 주소(다음API) */
	email varchar(50) not null,          /* 이메일(아아디/비밀번호 분실시에 사용)-형식체크필수 */
	homePage varchar(50),                /* 홈페이지(블로그) 주소 */
	job varchar(20),                      /* 회원 직업 */
	hobby varchar(100),                   /* 취미(2개 이상 선택가능, 구분자는 '/'로 한다.) */
	...
	point int default 100,               /* 회원 누적포인트(가입포인트100증정, 1회 방문시 10,1일 최대 50점까지 증가) */
