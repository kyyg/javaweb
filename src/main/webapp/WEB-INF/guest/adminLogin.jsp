...
<div class="container">
  <form name="myform" method="post" action="${ctp}/AdminLoginOk.gu">
	  ...
	  <table class="table table-bordered">
	    <tr>
	      <th>관리자아이디</th>
	      <td><input type="text" name="mid" id="mid" class="form-control" value="admin" required /></td>
	    </tr>
	    <tr>
	      <th>비밀번호</th>
	      <td><input type="password" name="pwd" id="pwd" class="form-control" value="1234" required /></td>
	    </tr>
	    <tr>
