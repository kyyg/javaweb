...
<p><br/></p>
<div class="container">
  <form name="myform" method="post" action="${ctp}/LoginOk.kk">
    <table class="table table-bordered text-center">
      ...
      <tr>
        <td colspan="2">
          ...
          <input type="button" value="회원가입" onclick="location.href='${ctp}/Join.kk';" class="btn btn-primary mr-4"/>
          <input type="button" value="비밀번호 찾기" onclick="location.href='findPwd.jsp';" class="btn btn-primary mr-4"/>
