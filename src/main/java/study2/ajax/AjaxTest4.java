...
public class AjaxTest4 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// HashMap 형식의 자료를 문자로 변환...
		
		// JSON형식의 자료를 사용하기위해 JSON객체를 생성할 수 있게 하는 라이브러리 추가
		// 주소 : https://code.google.com/archive/p/json-simple/downloads : 첫번째 파일 다운로드 후 lib폴더에 추가
		// JSON형식의 자료로 변경. Map형식 자료를 저장할 JSON 객체를 생성 
